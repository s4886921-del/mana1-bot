...
async def auto_poem_loop(app):
while True:
wait = random.randint(14400, 28800)
await asyncio.sleep(wait)
try:
with open(“chat_id.txt”, “r”) as f:
chat_id = f.read().strip()
if chat_id:
await app.bot.send_message(chat_id=int(chat_id), text=random.choice(POEMS))
except:
pass
...
async with app:
    ...
    asyncio.create_task(auto_poem_loop(app))
